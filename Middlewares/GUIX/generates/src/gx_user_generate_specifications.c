...
GX_DISPLAY display_screen_1024x600_control_block;
GX_WINDOW_ROOT display_screen_1024x600_root_window;
GX_CANVAS  display_screen_1024x600_canvas_control_block;

extern GX_CONST GX_THEME *display_screen_1024x600_theme_table[];
extern GX_CONST GX_STRING *display_screen_1024x600_language_table[];

GX_STUDIO_DISPLAY_INFO gx_window_display_table[1] =
{
    {
    "display_screen_1024x600",
    "display_screen_1024x600_canvas",
    display_screen_1024x600_theme_table,
    display_screen_1024x600_language_table,
    DISPLAY_SCREEN_1024X600_THEME_TABLE_SIZE,
    DISPLAY_SCREEN_1024X600_LANGUAGE_TABLE_SIZE,
    DISPLAY_SCREEN_1024X600_STRING_TABLE_SIZE,
    DISPLAY_SCREEN_1024X600_X_RESOLUTION,	/* x resolution                   */
    DISPLAY_SCREEN_1024X600_Y_RESOLUTION,	/* y resolution                   */
    &display_screen_1024x600_control_block,
    &display_screen_1024x600_canvas_control_block,
    &display_screen_1024x600_root_window,
    (GX_COLOR *)GX_DISPLAY_CANVAS_ADDR,		/* canvas memory area             */
    GX_DISPLAY_CANVAS_SIZE,					/* canvas memory size in bytes    */
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = gx_window_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &gx_window_display_table[display];
