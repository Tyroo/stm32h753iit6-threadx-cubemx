...
GX_CONST GX_COLOR display_screen_1024x600_theme_1_color_table[] =
{
    0x00000000,
    0x00007bef,
    0x0000e71c,
...
GX_CONST GX_FONT *display_screen_1024x600_theme_1_font_table[] =
{
...
static GX_CONST USHORT display_screen_1024x600_theme_1_radio_on_pixelmap_data[308] =
{
...
GX_CONST GX_PIXELMAP display_screen_1024x600_theme_1_radio_on_pixelmap =
{
    ...
    (GX_UBYTE *) display_screen_1024x600_theme_1_radio_on_pixelmap_data,
    sizeof(display_screen_1024x600_theme_1_radio_on_pixelmap_data),    /* the size of pixelmap_data*/
    NULL,
...
static GX_CONST USHORT display_screen_1024x600_theme_1_radio_off_pixelmap_data[308] =
{
...
GX_CONST GX_PIXELMAP display_screen_1024x600_theme_1_radio_off_pixelmap =
{
    0x00000001,                              /* major version                  */
    0x00000000,                              /* minor version                  */
    GX_PIXELMAP_COMPRESSED|GX_PIXELMAP_ALPHA,         /* flags                 */
    GX_COLOR_FORMAT_565RGB,                  /* Format                         */
    (GX_UBYTE *) display_screen_1024x600_theme_1_radio_off_pixelmap_data,
    sizeof(display_screen_1024x600_theme_1_radio_off_pixelmap_data),    /* the size of pixelmap_data*/
    NULL,
    0,                                       /* auxiliary data size            */
    0x00,                                    /* used for transparent iamges    */
    16,                                      /* width in pixel                 */
...
static GX_CONST USHORT display_screen_1024x600_theme_1_checkbox_on_pixelmap_data[242] =
{
...
GX_CONST GX_PIXELMAP display_screen_1024x600_theme_1_checkbox_on_pixelmap =
{
    0x00000001,                              /* major version                  */
    0x00000000,                              /* minor version                  */
    GX_PIXELMAP_COMPRESSED,                  /* flags                          */
    GX_COLOR_FORMAT_565RGB,                  /* Format                         */
    (GX_UBYTE *) display_screen_1024x600_theme_1_checkbox_on_pixelmap_data,
    sizeof(display_screen_1024x600_theme_1_checkbox_on_pixelmap_data),    /* the size of pixelmap_data*/
    NULL,
    0,                                       /* auxiliary data size            */
    0x00,                                    /* used for transparent iamges    */
    16,                                      /* width in pixel                 */
...
static GX_CONST USHORT display_screen_1024x600_theme_1_checkbox_off_pixelmap_data[217] =
{
    0x800f, 0x1a90, 0x000f, 0x1a90, 0xbe17, 0xe6d8, 0xde97, 0xde75, 0xde74, 0xde53, 
...
GX_CONST GX_PIXELMAP display_screen_1024x600_theme_1_checkbox_off_pixelmap =
{
    0x00000001,                              /* major version                  */
    0x00000000,                              /* minor version                  */
    GX_PIXELMAP_COMPRESSED,                  /* flags                          */
    GX_COLOR_FORMAT_565RGB,                  /* Format                         */
    (GX_UBYTE *) display_screen_1024x600_theme_1_checkbox_off_pixelmap_data,
    sizeof(display_screen_1024x600_theme_1_checkbox_off_pixelmap_data),    /* the size of pixelmap_data*/
    NULL,
    0,                                       /* auxiliary data size            */
    0x00,                                    /* used for transparent iamges    */
    16,                                      /* width in pixel                 */
...
GX_CONST GX_PIXELMAP *display_screen_1024x600_theme_1_pixelmap_table[] =
{
    GX_NULL,
    &display_screen_1024x600_theme_1_radio_on_pixelmap,
    &display_screen_1024x600_theme_1_radio_off_pixelmap,
    &display_screen_1024x600_theme_1_checkbox_on_pixelmap,
    &display_screen_1024x600_theme_1_checkbox_off_pixelmap
};
...
GX_CONST GX_STRING display_screen_1024x600_English_string_table[DISPLAY_SCREEN_1024X600_STRING_TABLE_SIZE] =
{
    {GX_NULL, 0},
...
GX_CONST GX_STRING *display_screen_1024x600_language_table[DISPLAY_SCREEN_1024X600_LANGUAGE_TABLE_SIZE] = 
{
    display_screen_1024x600_English_string_table,
};

GX_THEME display_screen_1024x600_theme_1 =
{
    (GX_COLOR *) display_screen_1024x600_theme_1_color_table,
    (GX_FONT **) display_screen_1024x600_theme_1_font_table,
    (GX_PIXELMAP **) display_screen_1024x600_theme_1_pixelmap_table,
    NULL,
    {
        20,                                  /* scroll width                   */
        18,                                  /* thumb width                    */
...
GX_CONST GX_THEME *display_screen_1024x600_theme_table[DISPLAY_SCREEN_1024X600_THEME_TABLE_SIZE] =
{
    &display_screen_1024x600_theme_1
};
